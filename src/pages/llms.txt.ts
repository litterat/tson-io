...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines = [
    ...
    '> and schema source files needed to read, write, and validate TSON.',
    '',
    '## Specification',
    '',
    ...specEntries.map(e => specLine(base, e)),
    '',
    '## Schema Source Files',
    '',
    `- [meta-kernel.tn1](${base}/2026-28/meta-kernel.tn1): Base kind constructors and the IS-A lattice root`,
    `- [meta.tn1](${base}/2026-28/meta.tn1): Annotation types and schema-level directives`,
    `- [core.tn1](${base}/2026-28/core.tn1): Core type library for data interchange`,
    '',
    '## Optional',
    '',
