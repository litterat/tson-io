...
> Revision note: the 2026 series is a working draft. Identifiers such as `https://tson.io/2026/36/m/core.tn` carry the revision number; when the revision changes, so do those URLs and every hash pin against them.
