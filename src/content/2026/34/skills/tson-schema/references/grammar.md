...
Verbatim excerpts from TSON Part 2 §12 (2026 Revision 34): the schema-body ABNF, the disambiguation summary, and the adjacency rules; followed by a condensed note on error categories and name hygiene at the schema layer. The header (`!!id`, `!!meta`, `!!import`) is Part 1 grammar; see the tson-data skill's grammar notes.
