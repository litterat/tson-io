...
- `http://tson.io/2026/m/core.tn1` and `https://tson.io/2026/m/core.tn1` — **same** entry; the scheme is a transport hint.
- `https://tson.io/2026/m/core.tn1` and the same URL with `?sha256=…` — same entry; the pinned form additionally requires verification (§10.2).
- `https://tson.io/2026/m/core.tn1` and `https://elsewhere.example/2026/m/core.tn1` — **different** entries; the host is load-bearing, so a fetch-endpoint change cannot silently redirect a name.
...
| Reference | Title | URL |
|-----------|-------|-----|
| TSON-DATA | TSON Part 1: Data Format | https://tson.io/2026/tson-part1-data |
| TSON-GUIDE | TSON Developer Guide (non-normative) | https://tson.io/2026/tson-guide |
